<template>
  ...
  <div id="yr1" class="hero-content text-center">
    <div class="max-w-md">
      <h1 class="text-5xl font-bold">What you'll learn in ths first year</h1>
      <p class="py-6">
        <NuxtImg src="https://www.wsc.ac.uk/favicon.ico" width="64" height="64"></NuxtImg>
        Is it for me?
...
<br>
    ...
    Emerging issues and impact of digital <br>
